    ...
    <form action="" method="post">
        ...
        if (isset($_POST['delete'])) { // If "delete" button is clicked.
            ...
            if (!empty($checked)) { // If at least 1 checkbox is checked.
                ...
                $sql = "DELETE FROM bookings WHERE StudentID IN ('" .
                        implode("','", $escaped) . "')";
...
// Validate sort, order and filter.
        ...
        $con = new mysqli(DB_HOST, DB_USER, DB_PASS, DB_NAME);
        $sql = "SELECT * FROM bookings WHERE Program LIKE '$program' ORDER BY $sort $order";
        ...
        <td colspan="6">
            %d record(s) returned.
            [ <a href="insert-booking.php">Insert booking</a> ]
        </td>
        </tr>',
                $result->num_rows);
        echo '</table>';
